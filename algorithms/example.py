...
logger_tracer.print("Searching for number 10 in an array of 100 elements", "red")
...
for key, number in enumerate(arr_of_numbers):
    ...
    logger_tracer.print("Searching for {} in the array index {}".format(num_to_search, key), "black")
    Tracer.step(19)
